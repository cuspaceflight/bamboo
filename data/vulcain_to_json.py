...
raw["Extension_Contour"] = np.loadtxt("Vulcain/Kirner_1993_Fig15_Contour.csv", delimiter =',', skiprows = 1)
raw["Chamber_Contour"] = np.loadtxt("Vulcain/Kirner_1993_Fig14_Contour.csv", delimiter =',', skiprows = 1)
...
output["Kirner"]["Engine Contour"] = {"x" : list(output["Kirner"]["Chamber Contour"]["x"]) + list(output["Kirner"]["Extension Contour"]["x"][1:]),
                                      "y" : list(output["Kirner"]["Chamber Contour"]["y"]) + list(output["Kirner"]["Extension Contour"]["y"][1:])}

# Collect the Ljungkrona_1991 data
raw["Ljungkrona_T_Exp"] = np.loadtxt("Vulcain/Ljungkrona_1998_Fig8_Exp.csv", delimiter =',', skiprows = 1)
